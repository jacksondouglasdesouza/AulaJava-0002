...
public class main {
	...
	public static void main(String[] args) {
		...
		System.out.println("O carro é: " + celta.getNome());
		celta.Ligar();
		System.out.println("Combustível do celta: [[ " + celta.getQuantidadeCombustivel() + "]] \n");
		
		System.out.println("O carro 2 é: " + honda.getNome());
		honda.Ligar();
		honda.abastecer(90);
